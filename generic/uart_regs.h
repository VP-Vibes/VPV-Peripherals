...
inline vpvper::generic::uart_regs::uart_regs(sc_core::sc_module_name nm)
...
template <unsigned BUSWIDTH> inline void vpvper::generic::uart_regs::registerResources(scc::tlm_target<BUSWIDTH>& target) {
