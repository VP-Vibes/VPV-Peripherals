...
, NAMEDD(regs, gen::soc_ctrl_regs) {
    ...
    SC_METHOD(reset_cb);
    sensitive << rst_i;
    regs->INFO.set_write_cb(
        [this](scc::sc_register<uint32_t>&, uint32_t const& v, sc_core::sc_time t) -> bool { return true; });
    regs->FETCH_ENABLE.set_write_cb(
        [this](scc::sc_register<uint32_t>&, uint32_t const& v, sc_core::sc_time t) -> bool { return true; });
    regs->CORE_STATUS.set_write_cb(
        [this](scc::sc_register<uint32_t>&, uint32_t const& v, sc_core::sc_time t) -> bool { return true; });
    regs->FLL_CLOCK_SELECT.set_write_cb(
        [this](scc::sc_register<uint32_t>&, uint32_t const& v, sc_core::sc_time t) -> bool { return true; });
    regs->INFO.set_read_cb(
        [this](scc::sc_register<gen::soc_ctrl_regs::INFO_t> const& reg, uint32_t& v, sc_core::sc_time t) -> bool {
